...
const CreateBookCategory = async (workspaceId: string, payload: CreateBookCategoryRequestPayload): Promise<CreateBookCategoryResult> => {
  const endpoint = `${Config.apiOrigin}/api/${workspaceId}/bookCategory`;
